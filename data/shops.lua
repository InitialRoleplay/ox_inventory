return {
	...
	-- 	}, locations = {
	-- 		vector3(-332.88, -251.25, 34.4)
	-- 	}, targets = {
	-- 		{ loc = vector3(-332.88, -251.25, 34.0), length = 1.0, width = 1.0, heading = 270.0, minZ = 30.5, maxZ = 32.0, distance = 6 }
	-- 	}
	-- },
	...
	Medicine = {
		...
		locations = {
			vector3(321.82, -581.84, 43.27)
		},
		targets = {
			{
				loc = vector3(321.82, -581.84, 43.27),
				length = 3.0,
				width = 1.0,
				heading = 338.24,
				minZ = 41.27,
	...
	Mechanic = {
		...
		inventory = {
			...
			{ name = 'steel', price = 0 },
			{ name = 'rubber', price = 0 },
			{ name = 'metalscrap', price = 0 },
		},
		locations = {
			vector3(-99.13, -2421.12, 6.0),
		},
		targets = {
			{
				loc = vector3(-98.7, -2421.12, 4.5),
				length = 2.0,
				width = 1.0,
				heading = 269.85,
				minZ = 6.5,
